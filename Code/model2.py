...
if __name__ == '__main__':
  ...
  def new_triangle(state, dt, w, W):
    ...
    return state
  def w1(state, model):
    return lambda_1/state["Triangle"]
  ...
  X1 = lambda t, x1, x2, e, c1, c2: lambda_1/x1-gamma*x1-nabla_plus*x1*e+nabla_minus*c1
  X2 = lambda t, x1, x2, e, c1, c2: lambda_2/x2-gamma*x2-nabla_plus*x2*e+nabla_minus*c2
